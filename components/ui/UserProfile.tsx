...
//     organization: "Acme Inc.", // Optional field
//   };
...
//       {isOpen && (
//         <div
//           className={`absolute right-0 mt-2 w-96 bg-white rounded-xl shadow-xl py-4 transition-all duration-300 ease-in-out transform ${isVisible ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2'} dark:bg-gray-800 border border-gray-200 dark:border-gray-700`}
//         >
...
//                 <h3 className="text-xl font-bold text-gray-800 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">{userData.name}</h3>
...
//             <button className="flex items-center space-x-3 w-full p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200 text-red-600 dark:text-red-400">
